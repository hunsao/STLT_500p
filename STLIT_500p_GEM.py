...
from google_auth_httplib2 import AuthorizedHttp # Simplificaremos esto
...
if 'data_loaded' not in st.session_state:
    ...
    st.session_state.images_per_page_display = 20 # Para paginación de imágenes
...
with st.expander("📋 Instrucciones para el archivo ZIP", expanded=not st.session_state.data_loaded):
    ...
    <ul>... (contenido de instrucciones)...</ul>
    """, unsafe_allow_html=True) # Acortado para brevedad
st.markdown(" ")
